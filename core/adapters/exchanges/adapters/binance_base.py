...
class BinanceBase:
    ...
    def _setup_urls(self):
        ...
        if self.config:
            ...
            # 验证并应用配置中的 URL
            if config_base_url:
                if URLValidator.is_allowed_url('binance', config_base_url, testnet, False):
            ...
            if config_ws_url:
                if URLValidator.is_allowed_url('binance', config_ws_url, testnet, True):
